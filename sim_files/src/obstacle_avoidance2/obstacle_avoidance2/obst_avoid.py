...
class ObstacleAvoidance(Node):
    ...
    def scan_callback(self, msg):
        ...
        if is_blocked_front and (is_blocked_fleft or is_blocked_fright):
        ...
        elif min_front < self.safe_distance or min_fleft < self.safe_distance or min_fright < self.safe_distance:
            ...
            if space_left > space_right:
                ...
                self.get_logger().info('Przeszkoda -> Obrót w LEWO')
            else:
                twist.angular.z = -self.angular_speed
                self.get_logger().info('Przeszkoda -> Obrót w PRAWO')
        else:
